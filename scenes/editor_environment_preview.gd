...
# Editor preview V33.
# Shows the approved single-file HQ canyon through the shared loader.
# Environment asset 9/36 stays disabled while canyon placement is reviewed.
...
func _rebuild_preview() -> void:
	...
	print(
		"EDITOR CANYON V33 HQ ASSET: compact=", snappedf(world_width, 1.0),
		"px top=", TOP_M,
